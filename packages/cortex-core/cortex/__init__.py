...
def build_all(config: Config, output_dir: str = "assets") -> dict[str, str]:
    ...
    plan: list[tuple[bool, str, str, str]] = [
        ...
        (config.cards.dna.enabled, "dna", "build", "code-dna.svg"),
        (config.cards.globe.enabled, "globe", "build", "skill-globe.svg"),
        (config.cards.particles.enabled, "particles", "build", "particle-cloud.svg"),
        (config.cards.now_playing.enabled, "now_playing", "build", "now-playing.svg"),
